...
<tr><td></td><td align=center><input type=submit value="Register" class="myButton">&nbsp;&nbsp;<input type=reset class=myButton> &nbsp;&nbsp; <a href="./Re.jsp">retrieve the registered users</a></td></tr>
</table>
